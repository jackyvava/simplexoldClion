...
inline Vector1 Vec1(const real s){Vector1 v;v[0]=s;return v;}
inline Vector1i Vec1i(const int s){Vector1i v;v[0]=s;return v;}
inline Vector1d Vec1d(const double s){Vector1d v;v[0]=s;return v;}
inline Vector1f Vec1f(const float s){Vector1f v;v[0]=s;return v;}
inline Vector1c Vec1c(const C s){Vector1c v;v[0]=s;return v;}
...
// CUDA programming
enum DataHolder { UNKNOWN, HOST, DEVICE };
