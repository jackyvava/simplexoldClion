...
namespace AuxFunc{
	...
	void Angle_And_Axis_Between(const Vector3& v1,const Vector3& v2,real& theta,Vector3& axis)
	{
		Vector3 a=v1.cross(v2);real s=a.norm();
		real c=v1.dot(v2);theta=atan2(s,c);axis=a/s;
	}
