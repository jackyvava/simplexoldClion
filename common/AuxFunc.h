...
namespace AuxFunc{
	...
	void Angle_And_Axis_Between(const Vector3& v1,const Vector3& v2,real& theta,Vector3& axis);		////theta [0,pi]
    ...
    ////Array operations
    template<class T_ARRAY,class T> void Fill(T_ARRAY& array,const T& value){std::fill(array.begin(),array.end(),value);}
