...
{face_grids.clear();for(int i=0;i<d;i++){VectorD domain_min=grid.domain_min+(VectorD::Ones()-VectorD::Unit(i))*grid.dx*(real).5;face_grids.push_back(Grid<d>(face_counts[i]-VectorDi::Ones(),grid.dx,domain_min));}}
